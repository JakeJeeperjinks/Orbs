// Console Text || DO NOT REMOVE OR CHANGE!
console.log('%cOrbs.ga', 'color:red;font-size: 48pt');
console.log('%cCreator: Triston Stuart', 'color:blue;font-size: 24pt');
...
console.log("%cClient Version : 2", css);
